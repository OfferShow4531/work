/*
„исло студентов, обучающихс€ по данному направлению программ по государственным образовательным грантам и госзаказу:
 онтингент студентов по программе и результаты обучени€ Ц 150 баллов (по состо€нию на 1 окт€бр€ 2020 г.)
*/
SELECT [StudentID]
,[Year]
